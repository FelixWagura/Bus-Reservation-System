...
int main() {
    ...
    // Add sample bus data
    buses[0].id = 1;
    strcpy(buses[0].name, "Easy-Coach");
    strcpy(buses[0].source, "Nairobi");
    strcpy(buses[0].destination, "Kitale");
    strcpy(buses[0].departureTime, "08:00 AM");
    buses[0].seatsAvailable = MAX_SEATS;

    buses[1].id = 2;
    strcpy(buses[1].name, "Lopha-travellors");
    strcpy(buses[1].source, "Kitale");
    strcpy(buses[1].destination, "Eldoret");
    strcpy(buses[1].departureTime, "9:30 AM");
    buses[1].seatsAvailable = MAX_SEATS;

    buses[1].id = 2;
    strcpy(buses[1].name, "Simba-coach");
    strcpy(buses[1].source, "Eldoret");
    strcpy(buses[1].destination, "Kisumu");
    strcpy(buses[1].departureTime, "11:00 AM");
    buses[1].seatsAvailable = MAX_SEATS;
